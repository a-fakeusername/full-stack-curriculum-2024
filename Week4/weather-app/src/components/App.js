...
const apiKey = 'c70faeeaf5ebf3fb6b5060c0e848c53c'; // Your OpenWeatherMap API key here
  ...
  return (
    <div className="app-container">
      ...
      */}
      ...
      <SideContainer apiKey={apiKey} updateSelectedCity={updateSelectedCity}/* Pass the city data update function as a prop to 'SideContainer' */ />
    </div>
  );
}
